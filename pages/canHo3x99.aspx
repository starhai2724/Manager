        ...
        <div class="wrapper">
            <div class="row">
                                        ...
                                        <div style="display:inline!important">
                                          <div style="text-align:center;display:inline!important"><span style="text-align:left">
                                            <div style="display:inline!important"><span style="margin:0px;padding:0px;outline:none"><font style="margin:0px;padding:0px;outline:none"><b style="font-weight:bold;color:rgb(51,51,51);font-size:13px">
                                              ...
                                              &nbsp;</b><a href="canHo3x99.aspx"  style="margin:0px;padding:0px;text-decoration:none;outline:none;" title="Căn hộ 3 phòng ngủ 97.9m2"><font color="#b45f06" size="3">Căn hộ 3 phòng ngủ 97.9m2</font><font color="#005596">&nbsp;</font> </a></font></span> <span style="color:#F00;font-weight:700;"></span></div>
                                            </span></div>
                                        </div>
                                        </font></span></font></div>
                                    </div>
                ...
                <div class="col col-sm-9 col-md-9 col-lg-9">
                    <h2 class="ss-form-entry" style="text-align: center;"><span style="color: #ff0000;"><label class="ss-q-item-label" for="entry_1025472522"><label class="ss-q-item-label" for="entry_1025472522">Căn hộ 3 phòng 97.9m2</label></label></span></h2>
<p><img class="aligncenter  wp-image-132" src="img/img/mbch.jpg"  alt="Mặt bằng căn hộ" width="1121" height="596" /></p>
<p><img class="aligncenter  wp-image-132" src="img/img/3x97.png"  alt="Mặt bằng căn hộ" width="1121" height="596" /></p>
