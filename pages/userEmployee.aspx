<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userEmployee.aspx.cs" Inherits="pages_userEmployee" MasterPageFile="~/masterPage/HomePage.master"%>



<asp:Content ContentPlaceHolderID="CPH1" runat="server">
    
    <script src="../js/userEmployee.js"></script>
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header" style="margin: 15px 0 20px;">Tài khoản nhân viên</h3>
            <button type="button" class="btn btn-primary pull-right" style="margin-top: -64px" onclick="clearUserEmployee()">Làm lại</button>
                    ...
                    <div class="col col-sm-3 col-md-3 col-lg-3 pull-right">
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button class="btn btn-default " type="button" onclick="searchUserEmployee()"><i class="glyphicon glyphicon-search"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
