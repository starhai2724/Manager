        ...
        <div class="wrapper">
            <div class="row">
                ...
                <div class="col col-sm-9 col-md-9 col-lg-9">
                    <h2 class="ss-form-entry" style="text-align: center;"><span style="color: #ff0000;"><label class="ss-q-item-label" for="entry_1025472522"><label class="ss-q-item-label" for="entry_1025472522">Căn hộ 2 phòng 76.8m2</label></label></span></h2>
<p><img class="aligncenter  wp-image-132" src="img/img/mbch.jpg"  alt="Mặt bằng căn hộ" width="1121" height="596" /></p>
<p><img class="aligncenter  wp-image-131" src="img/img/2x76.8.png"  alt="1 phòng ngủ" width="1010" height="466" /></p>
                 </div>
            </div>
